...
class VoronoiTerrain:
    def __init__(self, width=200, height=200, num_sites=200, num_groups=25):
        self.width = width
        self.height = height
...
if __name__ == "__main__":
    ...
    # 地形を生成
    print("\n地形を生成中...")
    terrain = VoronoiTerrain(width=200, height=200, num_sites=200, num_groups=25)
